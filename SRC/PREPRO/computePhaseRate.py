...
def computePhaseRateStep(PreProObs, PrevPreproObsInfo, SatLabel):
    ...
    if PrevPreproObsInfo[SatLabel]["PrevPhaseRateL1"] == Const.NAN and PrevPreproObsInfo[SatLabel]["PrevPhaseRateL2"] == Const.NAN:
        ...
        phaseRateStep_f1 = (PreProObs["L1Meters"] - PrevPreproObsInfo[SatLabel]["PrevL1"]) / ((PreProObs["Sod"] - PrevPreproObsInfo[SatLabel]["PrevEpoch"])**2)
        phaseRateStep_f2 = (PreProObs["L2Meters"] - PrevPreproObsInfo[SatLabel]["PrevL2"]) / ((PreProObs["Sod"] - PrevPreproObsInfo[SatLabel]["PrevEpoch"])**2)
